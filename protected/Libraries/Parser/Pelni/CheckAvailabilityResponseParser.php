...
class CheckAvailabilityResponseParser extends BaseResponseParser implements ResponseParser
{
    /**
    ...
    public function into(APIController $apiController)
    {
        ...
        if ($rc == "00") {
            ...
            $apiController->response->data = json_decode($this->message->get(PelniMessage::FIELD_DATA))->availability;
        }
