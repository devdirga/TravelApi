...
class PaymentResponseParser extends BaseResponseParser implements ResponseParser
{
    ...
    public function into(APIController $apiController)
    {
        ...
        if (
            Utility::isTesterOutlet($this->message->get(HotelMessage::FIELD_LOKET_ID)) ||
            ...
            $apiController->response->data->url_etiket = "http://api.Travel.co.id/app/generate_etiket?id_transaksi=" . $this->message->get(HotelMessage::FIELD_TRX_ID) . "&id_outlet=" . $this->message->get(HotelMessage::FIELD_LOKET_ID);
            $apiController->response->data->url_struk = "http://api.Travel.co.id/app/generate_struk?id_transaksi=" . $this->message->get(HotelMessage::FIELD_TRX_ID);
            ...
            $apiController->response->data->komisi = Utility::getKomisi($apiController, intval($this->message->get(HotelMessage::FIELD_TRX_ID)));
        } else {
