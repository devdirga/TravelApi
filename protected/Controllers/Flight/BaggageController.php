...
use Travel\Libraries\Parser\Flight\BaggageResponseParser;
...
class BaggageController extends APIController
{
    ...
    public function indexAction()
    {
        ...
        $depart_date = ($this->request->tgl_keberangkatan == "") ? $date : $this->request->tgl_keberangkatan;
        ...
        $message->set(FlightMessage::FIELD_DATE_DEPARTURE, $depart_date);
        $message->set(FlightMessage::FIELD_DATE_ARRIVAL, $depart_date);
        ...
        //$message->parse('RESERVASI*TPJT*3229643770*5*20190221091844*H2H*BS0004*141414*travel**BAGGAGE*20190220084553*TPIW*0*SUB*SRG*02/20/2019*02/20/2019*1*0*0*01****************************W01|SUB-SRG|1;W02|SUB-SRG|1;W03|SUB-SRG|1;W04|SUB-SRG|1;W05|SUB-SRG|1;W06|SUB-SRG|1#100000;200000;300000;400000;500000;600000#5;10;15;20;25;30***************************************************00*success');
